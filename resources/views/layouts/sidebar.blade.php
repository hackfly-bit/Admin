            ...
            <ul class="metismenu list-unstyled" id="side-menu">
               ...
               <li>
                    <a href="index">
                        ...
                        <span class="menu-item" data-key="t-ecommerce">Dashboard</span>
                    </a>
                </li>
                <li class="menu-title" data-key="t-menu">Room</li>


                <li>
                    <a href="{{ route('room.index') }}" class="has-arrow">
                        <i class="bx bx-check-square icon nav-icon"></i>
                        <span class="menu-item" data-key="t-user-grid">Room List</span>
                    </a>
                </li>
